...
export const SECTIONS = [
  {
    title: "1. 금리 지표",
    items: [
      { name: "연준 기준금리 (Fed Funds Upper)", seriesId: "DFEDTARU", fredId: "DFEDTARU", unit: "%", interpret: "lower-bullish" },
      { name: "미 국채 10년물 금리", seriesId: "DGS10", fredId: "DGS10", unit: "%", interpret: "lower-bullish" },
      { name: "장단기 금리차 (10Y-2Y)", seriesId: "T10Y2Y", fredId: "T10Y2Y", unit: "%p", interpret: "higher-bullish" },
      { name: "실질금리 (10Y TIPS)", seriesId: "DFII10", fredId: "DFII10", unit: "%", interpret: "lower-bullish" },
    ],
  },
  {
    title: "2. 시장 지표",
    items: [
      ...
      { name: "MOVE 지수 (채권 변동성)", seriesId: "MOVE", unit: "index", interpret: "lower-bullish",
        linkUrl: "https://finance.yahoo.com/quote/%5EMOVE/",
  ...
  },
  {
    title: "3. 유동성 지표",
    items: [
      { name: "M2 통화량", seriesId: "M2SL", fredId: "M2SL", unit: "$B", interpret: "higher-bullish" },
      { name: "연준 순유동성 (Net Liquidity)", seriesId: "NETLIQ", fredId: "WALCL", unit: "$B", interpret: "higher-bullish",
        note: "백엔드 합성: WALCL − WTREGEN − RRPONTSYD (링크·갱신일은 대표 시리즈 WALCL 기준)" },
      { name: "SOFR 금리", seriesId: "SOFR", fredId: "SOFR", unit: "%", interpret: "lower-bullish" },
      { name: "달러 인덱스 (Broad USD)", seriesId: "DTWEXBGS", fredId: "DTWEXBGS", unit: "index", interpret: "lower-bullish",
  ...
  },
  {
    title: "4. 경기 지표",
    items: [
      { name: "소비자물가지수 (CPI)", seriesId: "CPIAUCSL", fredId: "CPIAUCSL", unit: "index", interpret: "lower-bullish" },
      { name: "실업률 (Unemployment Rate)", seriesId: "UNRATE", fredId: "UNRATE", unit: "%", interpret: "lower-bullish",
        note: "값 낮을수록 고용 견조 → 호재 (단, 과열 시 긴축 우려)" },
      { name: "ISM 제조업 PMI (Philly Fed Proxy)", seriesId: "ISM_MFG", fredId: "GACDFSA066MSFRBPHI", unit: "index", interpret: "higher-bullish",
      ...
      { name: "금 가격 (London PM Fix)", seriesId: "GOLD", fredId: "GOLDAMGBD228NLBM", unit: "$/oz", interpret: "higher-bullish" },
      { name: "구리 가격 (Dr. Copper)", seriesId: "COPPER", fredId: "PCOPPUSDM", unit: "$/MT", interpret: "higher-bullish" },
      { name: "반도체 사이클 (SOX)", seriesId: "SOX", unit: "index", interpret: "higher-bullish",
        linkUrl: "https://finance.yahoo.com/quote/%5ESOX/",
  ...
  },
  {
    title: "5. 신용 지표",
    items: [
      { name: "하이일드 스프레드 (BofA)", seriesId: "BAMLH0A0HYM2", fredId: "BAMLH0A0HYM2", unit: "%", interpret: "lower-bullish" },
      { name: "SLOOS 대출 태도 (C&I)", seriesId: "DRTSCILM", fredId: "DRTSCILM", unit: "%", interpret: "lower-bullish",
  ...
  },
  {
    title: "6. 심리 지표",
    items: [
      { name: "VIX 지수 (공포 지수)", seriesId: "VIXCLS", fredId: "VIXCLS", unit: "index", interpret: "lower-bullish" },
      { name: "주식/채권 상대강도 (SPY/TLT)", seriesId: "SPY_TLT", unit: "ratio", interpret: "higher-bullish",
        linkUrl: "https://finance.yahoo.com/quote/TLT/",
